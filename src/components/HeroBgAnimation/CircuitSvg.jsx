...
/**
 * The geometric circuit mark. Extracted from the original hero animation and
 * brightened; motion/parallax is applied by the parent via CSS.
 */
const CircuitSvg = () => (
  <svg
        className="BgAnimation__svg" preserveAspectRatio="xMidYMid meet"
        viewBox="0 0 602 602"
        fill="none"
        xmlns="http://www.w3.org/2000/svg"
      >
        <g opacity="0.38" filter="url(#circuitGlow)">
          <path
            fillRule="evenodd"
            clipRule="evenodd"
